...
public class AppConfig {
	...
	public static int SOFT_FAIL_INTERVAL;
	public static int HARD_FAIL_INTERVAL;
	public static int BACKUP_INTEVRAL;

	public static ChordState chordState;

	//TODO: RA Logika
	public static RAState raState;
	...
	public static void readConfig(String configName, int serventId){
		...
		try {
			WORKING_DIRECTORY = properties.getProperty("dir");
//			timestampedStandardPrint("Radni koren: " + WORKING_DIRECTORY);
		} catch (Exception e){
			timestampedErrorPrint("Problem reading working directory. Exiting...");
			e.printStackTrace();
			System.exit(0);
		}
		try {
			SOFT_FAIL_INTERVAL = Integer.parseInt(properties.getProperty("soft_fail"));
		} catch (NumberFormatException e){
			timestampedErrorPrint("Problem reading soft_fail. Exiting...");
			System.exit(0);
		}
		try {
			HARD_FAIL_INTERVAL = Integer.parseInt(properties.getProperty("hard_fail"));
		} catch (NumberFormatException e){
			timestampedErrorPrint("Problem reading hard_fail. Exiting...");
			System.exit(0);
		}
		try {
			BACKUP_INTEVRAL = Integer.parseInt(properties.getProperty("backup_interval"));
		} catch (NumberFormatException e){
			timestampedErrorPrint("Problem reading backup_interval. Exiting...");
			System.exit(0);
		}
