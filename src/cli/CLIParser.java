...
import cli.command.files.GetFilesCommand;
...
public class CLIParser implements Runnable, Cancellable {
	...
	public CLIParser(SimpleServentListener listener, DistributedMutex mutex, Backupper backupper) {
		...
		commandList.add(new StopCommand(this, listener, backupper));
		commandList.add(new AddFriendCommand());
		commandList.add(new JoinAfterCommand());
		commandList.add(new RemoveFileCommand());
		commandList.add(new GetFilesCommand());
	}
